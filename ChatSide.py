                ...
                if(len(chating_panel) > 0):
                    ...
                    try:
                        ...
                        for i in range(len(before_snack_gifs_users)):
                            ...
                            if before_snack_gifs_users[i]['Coin'] != snack_gifs_users[i]['Coin']:
                    ...
                    try:
                        ...
                        for i in range(len(new_array)):
                            worksheet.update(f"E{i + 5 + len(before_snack_gifs_users)}", [[new_array[i]['UserName']]], value_input_option="USER_ENTERED")
